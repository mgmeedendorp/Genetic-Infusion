...
public class BlockBush extends SCBlock {
    ...
    public ArrayList<ItemStack> getBlockDropped(World world, int x, int y, int z, int metadata, int fortune) {
        if(CommonProxy.proxy.isRenderWorld(world)) return null;
    ...
    public BushType getType(int metadata) {
        switch(metadata) {
            case 0: return BushManager.typeNormal;
            case 1: return BushManager.typeBlue;
            default : return BushManager.typeNormal;
        }
    }
