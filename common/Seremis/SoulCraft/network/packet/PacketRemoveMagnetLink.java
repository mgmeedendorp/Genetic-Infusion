...
public class PacketRemoveMagnetLink extends SCPacket {
    ...
    public PacketRemoveMagnetLink(MagnetLink link) {
        this((int) link.line.head.x, (int) link.line.head.y, (int) link.line.head.z, (int) link.line.tail.x, (int) link.line.tail.y, (int) link.line.tail.z);
    }

    public PacketRemoveMagnetLink(int x1, int y1, int z1, int x2, int y2, int z2) {
        super(PacketTypeHandler.REMOVE_MAGNET_LINK);
        this.x1 = x1;
        this.y1 = y1;
        this.z1 = z1;
