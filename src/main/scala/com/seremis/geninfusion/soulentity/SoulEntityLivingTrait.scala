...
trait SoulEntityLivingTrait extends EntityLiving with ISoulEntity with IEntityAdditionalSpawnData {
    ...
    var methodLogic: MethodLogic = new MethodLogic(this)
    ...
    override def func_184213_bq(): Boolean = callMethod(FuncEntityFunc_184213_bq, () => super.func_184213_bq())
    ...
    override def getDistanceSq(x: Double, y: Double, z: Double): Double = callMethod(FuncEntityGetDistanceSq_Coord, () => super.getDistanceSq(x, y, z), x, y, z)
    override def getDistanceSq(pos: BlockPos): Double = callMethod(FuncEntityGetDistanceSq_BlockPos, () => super.getDistanceSq(pos), pos)
    ...
    override def getPassengers: util.List[Entity] = callMethod(FuncEntityGetPassengers, () => super.getPassengers)
    ...
    override def getRecursivePassengersByType[T <: Entity](entityClass: Class[T]): util.Collection[T] = callMethod(FuncEntityGetRecursivePassengersByType_Collection, () => super.getRecursivePassengersByType(entityClass), entityClass).asInstanceOf[util.Collection[T]]
    ...
    override def readEntityFromNBT(var1: NBTTagCompound): Unit = callMethod(FuncEntityReadEntityFromNBT, () => super.readEntityFromNBT(var1), var1)
    ...
    override def setBossNonVisibleTo(player: EntityPlayerMP): Unit = callMethod(FuncEntitySetBossNonVisibleTo, () => super.setBossNonVisibleTo(player), player)
    override def setBossVisibleTo(player: EntityPlayerMP): Unit = callMethod(FuncEntitySetBossVisibleTo, () => super.setBossVisibleTo(player), player)
    override def setCommandStat(tpe: Type, amount: Int): Unit = callMethod(FuncEntitySetCommandStat, () => super.setCommandStat(tpe, amount), tpe, amount)
    ...
    override def startRiding(entityIn: Entity): Boolean = callMethod(FuncEntityStartRiding_OneParam, () => super.startRiding(entityIn), entityIn)
    override def startRiding(entityIn: Entity, force: Boolean): Boolean = callMethod(FuncEntityStartRiding_TwoParam, () => super.startRiding(entityIn, force), entityIn, force)
    ...
    override def writeEntityToNBT(var1: NBTTagCompound): Unit = callMethod(FuncEntityWriteEntityToNBT, () => super.writeEntityToNBT(var1), var1)
    ...
    override def getItemStackFromSlot(var1: EntityEquipmentSlot): ItemStack = callMethod(FuncEntityLivingBaseGetItemStackFromSlot, () => super.getItemStackFromSlot(var1), var1)
    ...
    override def removePotionEffect(p_184589_1_ : Potion): Unit = callMethod(FuncEntityLivingBaseRemovePotionEffect, () => super.removePotionEffect(p_184589_1_), p_184589_1_)
