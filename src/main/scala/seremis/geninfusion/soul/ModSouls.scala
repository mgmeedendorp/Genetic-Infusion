...
import seremis.geninfusion.api.lib.EntityMethods._
...
import seremis.geninfusion.soul.methods.EntityMethodsEntity._
...
object ModSouls {
    ...
    def init() {
        ...
        entityMethodRegistry.register(EntityGetEntityId, GetEntityId, new MethodGetEntityId())
        entityMethodRegistry.register(EntitySetEntityId, SetEntityId, new MethodSetEntityId())
        entityMethodRegistry.register(EntityEntityInit, EntityInit, new MethodEntityInit())
        entityMethodRegistry.register(EntityGetDataWatcher, GetDataWatcher, new MethodGetDataWatcher())
        entityMethodRegistry.register(EntityEquals, Equals, new MethodEquals())
        entityMethodRegistry.register(EntityHashCode, HashCode, new MethodHashCode())
        entityMethodRegistry.register(EntityPreparePlayerToSpawn, PreparePlayerToSpawn, new MethodPreparePlayerToSpawn())
        entityMethodRegistry.register(EntitySetDead, SetDead, new MethodSetDead())
        entityMethodRegistry.register(EntitySetSize, SetSize, new MethodSetSize())
        entityMethodRegistry.register(EntitySetRotation, SetRotation, new MethodSetRotation())
        entityMethodRegistry.register(EntitySetPosition, SetPosition, new MethodSetPosition())
        entityMethodRegistry.register(EntitySetAngles, SetAngles, new MethodSetAngles())
        entityMethodRegistry.register(EntityOnUpdate, OnUpdate, new MethodOnUpdate())
        entityMethodRegistry.register(EntityOnEntityUpdate, OnEntityUpdate, new MethodOnEntityUpdate())
        entityMethodRegistry.register(EntityGetMaxInPortalTime, GetMaxInPortalTime, new MethodGetMaxInPortalTime())
        entityMethodRegistry.register(EntitySetOnFireFromLava, SetOnFireFromLava, new MethodSetOnFireFromLava())
        entityMethodRegistry.register(EntitySetFire, SetFire, new MethodSetFire())
        entityMethodRegistry.register(EntityExtinguish, Extinguish, new MethodExtinguish())
        entityMethodRegistry.register(EntityKill, Kill, new MethodKill())
        entityMethodRegistry.register(EntityIsOffsetPositionInLiquid, IsOffsetPositionInLiquid, new MethodIsOffsetPositionInLiquid())
        entityMethodRegistry.register(EntityMoveEntity, MoveEntity, new MethodMoveEntity())
        entityMethodRegistry.register(EntityGetSwimSound, GetSwimSound, new MethodGetSwimSound())
        entityMethodRegistry.register(EntityDoBlockCollisions, DoBlockCollisions, new MethodDoBlockCollisions())
        entityMethodRegistry.register(EntityPlayStepSound, PlayStepSound, new MethodPlayStepSound())
        entityMethodRegistry.register(EntityPlaySound, PlaySound, new MethodPlaySound())
        entityMethodRegistry.register(EntityCanTriggerWalking, CanTriggerWalking, new MethodCanTriggerWalking())
        entityMethodRegistry.register(EntityUpdateFallState, UpdateFallState, new MethodUpdateFallState())
        entityMethodRegistry.register(EntityGetBoundingBox, GetBoundingBox, new MethodGetBoundingBox())
        entityMethodRegistry.register(EntityDealFireDamage, DealFireDamage, new MethodDealFireDamage())
        entityMethodRegistry.register(EntityIsImmuneToFire, IsImmuneToFire, new MethodIsImmuneToFire())
        entityMethodRegistry.register(EntityFall, Fall, new MethodFall())
        entityMethodRegistry.register(EntityIsWet, IsWet, new MethodIsWet())
        entityMethodRegistry.register(EntityIsInWater, IsInWater, new MethodIsInWater())
        entityMethodRegistry.register(EntityHandleWaterMovement, HandleWaterMovement, new MethodHandleWaterMovement())
        entityMethodRegistry.register(EntityGetSplashSound, GetSplashSound, new MethodGetSplashSound())
        entityMethodRegistry.register(EntityIsInsideOfMaterial, IsInsideOfMaterial, new MethodIsInsideOfMaterial())
        entityMethodRegistry.register(EntityGetEyeHeight, GetEyeHeight, new MethodGetEyeHeight())
        entityMethodRegistry.register(EntityHandleLavaMovement, HandleLavaMovement, new MethodHandleLavaMovement())
        entityMethodRegistry.register(EntityMoveFlying, MoveFlying, new MethodMoveFlying())
        entityMethodRegistry.register(EntityGetBrightnessForRender, GetBrightnessForRender, new MethodGetBrightnessForRender())
        entityMethodRegistry.register(EntityGetBrightness, GetBrightness, new MethodGetBrightness())
        entityMethodRegistry.register(EntitySetWorld, SetWorld, new MethodSetWorld())
        entityMethodRegistry.register(EntitySetPositionAndRotation, SetPositionAndRotation, new MethodSetPositionAndRotation())
        entityMethodRegistry.register(EntitySetLocationAndAngles, SetLocationAndAngles, new MethodSetLocationAndAngles())
        entityMethodRegistry.register(EntityGetDistanceToEntity, GetDistanceToEntity, new MethodGetDistanceToEntity())
        entityMethodRegistry.register(EntityGetDistanceSq, GetDistanceSq, new MethodGetDistanceSq())
        entityMethodRegistry.register(EntityGetDistance, GetDistance, new MethodGetDistance())
        entityMethodRegistry.register(EntityGetDistanceSqToEntity, GetDistanceSqToEntity, new MethodGetDistanceSqToEntity())
        entityMethodRegistry.register(EntityOnCollideWithPlayer, OnCollideWithPlayer, new MethodOnCollideWithPlayer())
        entityMethodRegistry.register(EntityApplyEntityCollision, ApplyEntityCollision, new MethodApplyEntityCollision())
        entityMethodRegistry.register(EntityAddVelocity, AddVelocity, new MethodAddVelocity())
        entityMethodRegistry.register(EntitySetBeenAttacked, SetBeenAttacked, new MethodSetBeenAttacked())
        entityMethodRegistry.register(EntityAttackEntityFrom, AttackEntityFrom, new MethodAttackEntityFrom())
        entityMethodRegistry.register(EntityCanBeCollidedWith, CanBeCollidedWith, new MethodCanBeCollidedWith())
        entityMethodRegistry.register(EntityCanBePushed, CanBePushed, new MethodCanBePushed())
        entityMethodRegistry.register(EntityAddToPlayerScore, AddToPlayerScore, new MethodAddToPlayerScore())
        entityMethodRegistry.register(EntityIsInRangeToRender3d, IsInRangeToRender3d, new MethodIsInRangeToRender3d())
        entityMethodRegistry.register(EntityIsInRangeToRenderDist, IsInRangeToRenderDist, new MethodIsInRangeToRenderDist())
        entityMethodRegistry.register(EntityWriteMountToNBT, WriteMountToNBT, new MethodWriteMountToNBT())
        entityMethodRegistry.register(EntityWriteToNBTOptional, WriteToNBTOptional, new MethodWriteToNBTOptional())
        entityMethodRegistry.register(EntityWriteToNBT, WriteToNBT, new MethodWriteToNBT())
        entityMethodRegistry.register(EntityReadFromNBT, ReadFromNBT, new MethodReadFromNBT())
        entityMethodRegistry.register(EntityShouldSetPosAfterLoading, ShouldSetPosAfterLoading, new MethodShouldSetPosAfterLoading())
        entityMethodRegistry.register(EntityGetEntityString, GetEntityString, new MethodGetEntityString())
        entityMethodRegistry.register(EntityReadEntityFromNBT, ReadEntityFromNBT, new MethodReadEntityFromNBT())
        entityMethodRegistry.register(EntityWriteEntityToNBT, WriteEntityToNBT, new MethodWriteEntityToNBT())
        entityMethodRegistry.register(EntityOnChunkLoad, OnChunkLoad, new MethodOnChunkLoad())
        entityMethodRegistry.register(EntityNewDoubleNBTList, NewDoubleNBTList, new MethodNewDoubleNBTList())
        entityMethodRegistry.register(EntityNewFloatNBTList, NewFloatNBTList, new MethodNewFloatNBTList())
        entityMethodRegistry.register(EntityDropItem_, DropItem, new MethodDropItem())
        entityMethodRegistry.register(EntityDropItemWithOffset, DropItemWithOffset, new MethodDropItemWithOffset())
        entityMethodRegistry.register(EntityEntityDropItem, EntityDropItem, new MethodEntityDropItem())
        entityMethodRegistry.register(EntityGetShadowSize, GetShadowSize, new MethodGetShadowSize())
        entityMethodRegistry.register(EntityIsEntityAlive, IsEntityAlive, new MethodIsEntityAlive())
        entityMethodRegistry.register(EntityIsEntityInsideOpaqueBlock, IsEntityInsideOpaqueBlock, new MethodIsEntityInsideOpaqueBlock())
        entityMethodRegistry.register(EntityInteractFirst, InteractFirst, new MethodInteractFirst())
        entityMethodRegistry.register(EntityGetCollisionBox, GetCollisionBox, new MethodGetCollisionBox())
        entityMethodRegistry.register(EntityUpdateRidden, UpdateRidden, new MethodUpdateRidden())
        entityMethodRegistry.register(EntityUpdateRiderPosition, UpdateRiderPosition, new MethodUpdateRiderPosition())
        entityMethodRegistry.register(EntityGetYOffset, GetYOffset, new MethodGetYOffset())
        entityMethodRegistry.register(EntityGetMountedYOffset, GetMountedYOffset, new MethodGetMountedYOffset())
        entityMethodRegistry.register(EntityMountEntity, MountEntity, new MethodMountEntity())
        entityMethodRegistry.register(EntitySetPositionAndRotation2, SetPositionAndRotation2, new MethodSetPositionAndRotation2())
        entityMethodRegistry.register(EntityGetCollisionBorderSize, GetCollisionBorderSize, new MethodGetCollisionBorderSize())
        entityMethodRegistry.register(EntityGetLookVec, GetLookVec, new MethodGetLookVec())
        entityMethodRegistry.register(EntitySetInPortal, SetInPortal, new MethodSetInPortal())
        entityMethodRegistry.register(EntityGetPortalCooldown, GetPortalCooldown, new MethodGetPortalCooldown())
        entityMethodRegistry.register(EntitySetVelocity, SetVelocity, new MethodSetVelocity())
        entityMethodRegistry.register(EntityHandleHealthUpdate, HandleHealthUpdate, new MethodHandleHealthUpdate())
        entityMethodRegistry.register(EntityPerformHurtAnimation, PerformHurtAnimation, new MethodPerformHurtAnimation())
        entityMethodRegistry.register(EntityGetInventory, GetInventory, new MethodGetInventory())
        entityMethodRegistry.register(EntitySetCurrentItemOrArmor, SetCurrentItemOrArmor, new MethodSetCurrentItemOrArmor())
        entityMethodRegistry.register(EntityIsBurning, IsBurning, new MethodIsBurning())
        entityMethodRegistry.register(EntityIsRiding, IsRiding, new MethodIsRiding())
        entityMethodRegistry.register(EntityIsSneaking, IsSneaking, new MethodIsSneaking())
        entityMethodRegistry.register(EntitySetSneaking, SetSneaking, new MethodSetSneaking())
        entityMethodRegistry.register(EntityIsSprinting, IsSprinting, new MethodIsSprinting())
        entityMethodRegistry.register(EntitySetSprinting, SetSprinting, new MethodSetSprinting())
        entityMethodRegistry.register(EntityIsInvisible, IsInvisible, new MethodIsInvisible())
        entityMethodRegistry.register(EntityIsInvisibleToPlayer, IsInvisibleToPlayer, new MethodIsInvisibleToPlayer())
        entityMethodRegistry.register(EntitySetInvisible, SetInvisible, new MethodSetInvisible())
        entityMethodRegistry.register(EntityIsEating, IsEating, new MethodIsEating())
        entityMethodRegistry.register(EntitySetEating, SetEating, new MethodSetEating())
        entityMethodRegistry.register(EntityGetFlag, GetFlag, new MethodGetFlag())
        entityMethodRegistry.register(EntitySetFlag, SetFlag, new MethodSetFlag())
        entityMethodRegistry.register(EntityGetAir, GetAir, new MethodGetAir())
        entityMethodRegistry.register(EntitySetAir, SetAir, new MethodSetAir())
        entityMethodRegistry.register(EntityOnStruckByLightning, OnStruckByLightning, new MethodOnStruckByLightning())
        entityMethodRegistry.register(EntityOnKillEntity, OnKillEntity, new MethodOnKillEntity())
        entityMethodRegistry.register(EntityPushOutOfBlocks, PushOutOfBlocks, new MethodPushOutOfBlocks())
        entityMethodRegistry.register(EntitySetInWeb, SetInWeb, new MethodSetInWeb())
        entityMethodRegistry.register(EntityGetCommandSenderName, GetCommandSenderName, new MethodGetCommandSenderName())
        entityMethodRegistry.register(EntityGetParts, GetParts, new MethodGetParts())
        entityMethodRegistry.register(EntityIsEntityEqual, IsEntityEqual, new MethodIsEntityEqual())
        entityMethodRegistry.register(EntityGetRotationYawHead, GetRotationYawHead, new MethodGetRotationYawHead())
        entityMethodRegistry.register(EntitySetRotationYawHead, SetRotationYawHead, new MethodSetRotationYawHead())
        entityMethodRegistry.register(EntityCanAttackWithItem, CanAttackWithItem, new MethodCanAttackWithItem())
        entityMethodRegistry.register(EntityHitByEntity, HitByEntity, new MethodHitByEntity())
        entityMethodRegistry.register(EntityToString, ToString, new MethodToString())
        entityMethodRegistry.register(EntityIsEntityInvulnerable, IsEntityInvulnerable, new MethodIsEntityInvulnerable())
        entityMethodRegistry.register(EntityCopyLocationAndAnglesFrom, CopyLocationAndAnglesFrom, new MethodCopyLocationAndAnglesFrom())
        entityMethodRegistry.register(EntityCopyDataFrom, CopyDataFrom, new MethodCopyDataFrom())
        entityMethodRegistry.register(EntityTravelToDimension, TravelToDimension, new MethodTravelToDimension())
        entityMethodRegistry.register(EntityGetExplosionResistance, GetExplosionResistance, new MethodGetExplosionResistance())
        entityMethodRegistry.register(EntityFunc_145774_a, Func_145774_a, new MethodFunc_145774_a())
        entityMethodRegistry.register(EntityGetMaxFallHeight, GetMaxFallHeight, new MethodGetMaxFallHeight())
        entityMethodRegistry.register(EntityGetTeleportDirection, GetTeleportDirection, new MethodGetTeleportDirection())
        entityMethodRegistry.register(EntityDoesEntityNotTriggerPressurePlate, DoesEntityNotTriggerPressurePlate, new MethodDoesEntityNotTriggerPressurePlate())
        entityMethodRegistry.register(EntityAddEntityCrashInfo, AddEntityCrashInfo, new MethodAddEntityCrashInfo())
        entityMethodRegistry.register(EntityCanRenderOnFire, CanRenderOnFire, new MethodCanRenderOnFire())
        entityMethodRegistry.register(EntityGetUniqueID, GetUniqueID, new MethodGetUniqueID())
        entityMethodRegistry.register(EntityIsPushedByWater, IsPushedByWater, new MethodIsPushedByWater())
        entityMethodRegistry.register(EntityGetFormattedCommandSenderName, GetFormattedCommandSenderName, new MethodGetFormattedCommandSenderName())
        entityMethodRegistry.register(EntityFunc_145781_i, Func_145781_i, new MethodFunc_145781_i())
        entityMethodRegistry.register(EntityGetEntityData, GetEntityData, new MethodGetEntityData())
        entityMethodRegistry.register(EntityShouldRiderSit, ShouldRiderSit, new MethodShouldRiderSit())
        entityMethodRegistry.register(EntityGetPickedResult, GetPickedResult, new MethodGetPickedResult())
        entityMethodRegistry.register(EntityGetPersistentID, GetPersistentID, new MethodGetPersistentID())
        entityMethodRegistry.register(EntityResetEntityId, ResetEntityId, new MethodResetEntityId())
        entityMethodRegistry.register(EntityShouldRenderInPass, ShouldRenderInPass, new MethodShouldRenderInPass())
        entityMethodRegistry.register(EntityIsCreatureType, IsCreatureType, new MethodIsCreatureType())
        entityMethodRegistry.register(EntityRegisterExtendedProperties, RegisterExtendedProperties, new MethodRegisterExtendedProperties())
        entityMethodRegistry.register(EntityGetExtendedProperties, GetExtendedProperties, new MethodGetExtendedProperties())
        entityMethodRegistry.register(EntityCanRiderInteract, CanRiderInteract, new MethodCanRiderInteract())
        entityMethodRegistry.register(EntityShouldDismountInWater, ShouldDismountInWater, new MethodShouldDismountInWater())
