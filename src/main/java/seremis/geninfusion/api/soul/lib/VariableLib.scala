...
object VariableLib {
    ...
    final val EntityPossibleAnimations = field("possibleAnimations")
    final val EntityActiveAnimations = field("activeAnimations")
    final val EntityPendingAnimations = field("pendingAnimations")
    ...
    final val EntityFuseState = field("fuseState")
    final val EntityCharged = field("charged")
    final val EntityIgnited = field("ignited")
    final val EntityExplosionRadius = field("explosionRadius")
    final val EntityFuseTime = field("fuseTime")
    final val EntityTimeSinceIgnited = field("timeSinceIgnited")
    ...
    final val EntityHealth = field("health")
    final val EntityCreatureAttribute = field("creatureAttribute")
    final val EntityExperienceValue = field("field_70728_aV")
    final val EntityEquipmentDropChances = field("field_82174_bp")
    final val EntityAIEnabled = field("aiEnabled")
    final val EntityCaptureDrops = field("captureDrops")
    final val EntityCapturedDrops = field("capturedDrops")
    ...
    final val EntityTalkInterval = field("talkInterval")
    final val EntityPartialTickTime = field("partialTickTime")
    final val DataWatcherNameTag = field("nameTag")
