...
public class Localizations {
    ...
    public static final String LOC_COMMONPROXY = "seremis.geninfusion.core.proxy.CommonProxy";
    public static final String LOC_CLIENTPROXY = "seremis.geninfusion.core.proxy.ClientProxy";
