...
public class TraitItemDrops extends Trait {
    ...
    private void dropFewItems(IEntitySoulCustom entity, boolean recentlyHit, int lootingLevel) {
        ItemStack[] drops = SoulHelper.geneRegistry().getValueFromAllele(entity, Genes.GENE_ITEM_DROPS);
    ...
    private void dropEquipment(IEntitySoulCustom entity, boolean recentlyHit, int lootingLevel) {
        float[] equipmentDropChances = SoulHelper.geneRegistry().getValueFromAllele(entity, Genes.GENE_EQUIPMENT_DROP_CHANCES);
    ...
    private void dropRareDrop(IEntitySoulCustom entity, boolean reallyRandomThingy) {
        ItemStack[] drops = SoulHelper.geneRegistry().getValueFromAllele(entity, Genes.GENE_RARE_ITEM_DROPS);
        float[] dropChances = SoulHelper.geneRegistry().getValueFromAllele(entity, Genes.GENE_RARE_ITEM_DROP_CHANCES);
