...
public class TraitFluids extends Trait {
    ...
    public void onUpdate(IEntitySoulCustom entity) {
        boolean drownsInWater = SoulHelper.geneRegistry().getValueFromAllele(entity, Genes.GENE_DROWNS_IN_WATER);
        ...
        boolean drownsInAir = SoulHelper.geneRegistry().getValueFromAllele(entity, Genes.GENE_DROWNS_IN_AIR);
