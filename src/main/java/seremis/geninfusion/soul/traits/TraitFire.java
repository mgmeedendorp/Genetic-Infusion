...
public class TraitFire extends Trait {
    ...
    public void firstTick(IEntitySoulCustom entity) {
        entity.setBoolean("isImmuneToFire", SoulHelper.geneRegistry().<Boolean>getValueFromAllele(entity, Genes.GENE_IMMUNE_TO_FIRE));
    }
    ...
    public void onUpdate(IEntitySoulCustom entity) {
        ...
        boolean childrenBurnInDaylight = SoulHelper.geneRegistry().getValueFromAllele(entity, Genes.GENE_CHILDREN_BURN_IN_DAYLIGHT);
    ...
    public boolean attackEntityAsMob(IEntitySoulCustom entity, Entity entityToAttack) {
        ...
        boolean setEntitiesOnFire = SoulHelper.geneRegistry().getValueFromAllele(entity, Genes.GENE_SET_ON_FIRE_FROM_ATTACK);
