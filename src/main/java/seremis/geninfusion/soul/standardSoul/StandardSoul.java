...
public class StandardSoul implements IStandardSoul {
    ...
    public IChromosome getChromosomeFromGene(EntityLiving entity, String gene) {
        ...
        if(gene.equals(Genes.GENE_AI_AVOID_ENTITY))
            return new Chromosome(new AlleleBoolean(true, false));
        if(gene.equals(Genes.GENE_AI_AVOID_ENTITY_INDEX))
            return new Chromosome(new AlleleIntArray(false, new int[]{3}));
        if(gene.equals(Genes.GENE_AI_AVOID_ENTITY_FAR_SPEED))
            return new Chromosome(new AlleleDoubleArray(false, new double[]{1.0D}));
        if(gene.equals(Genes.GENE_AI_AVOID_ENTITY_NEAR_SPEED))
            return new Chromosome(new AlleleDoubleArray(false, new double[]{1.2D}));
        if(gene.equals(Genes.GENE_AI_AVOID_ENTITY_RANGE))
            return new Chromosome(new AlleleFloatArray(false, new float[]{6.0F}));
        if(gene.equals(Genes.GENE_AI_AVOID_ENTITY_TARGET))
            return new Chromosome(new AlleleClassArray(false, new Class[]{EntityCreeper.class}));

        if(gene.equals(Genes.GENE_AI_BEG))
            return new Chromosome(new AlleleBoolean(true, false));
        if(gene.equals(Genes.GENE_AI_BEG_INDEX))
            return new Chromosome(new AlleleInteger(true, 8));
        if(gene.equals(Genes.GENE_AI_BEG_RANGE))
            return new Chromosome(new AlleleFloat(false, 0.0F));

        if(gene.equals(Genes.GENE_AI_BREAK_DOOR))
            return new Chromosome(new AlleleBoolean(true, false));
        if(gene.equals(Genes.GENE_AI_BREAK_DOOR_INDEX))
            return new Chromosome(new AlleleInteger(true, 1));

        if(gene.equals(Genes.GENE_AI_CONTROLLED_BY_PLAYER))
            return new Chromosome(new AlleleBoolean(true, false));
        if(gene.equals(Genes.GENE_AI_CONTROLLED_BY_PLAYER_INDEX))
            return new Chromosome(new AlleleInteger(true, 2));
        if(gene.equals(Genes.GENE_AI_CONTROLLED_BY_PLAYER_MAX_SPEED))
            return new Chromosome(new AlleleDouble(false, 1.0D));

        if(gene.equals(Genes.GENE_AI_CREEPER_SWELL))
            return new Chromosome(new AlleleBoolean(true, false));
        if(gene.equals(Genes.GENE_AI_CREEPER_SWELL_INDEX))
            return new Chromosome(new AlleleInteger(true, 2));

        if(gene.equals(Genes.GENE_AI_DEFEND_VILLAGE))
            return new Chromosome(new AlleleBoolean(true, false));
        if(gene.equals(Genes.GENE_AI_DEFEND_VILLAGE_INDEX))
            return new Chromosome(new AlleleInteger(true, 1));

        if(gene.equals(Genes.GENE_AI_EAT_GRASS))
            return new Chromosome(new AlleleBoolean(true, false));
        if(gene.equals(Genes.GENE_AI_EAT_GRASS_INDEX))
            return new Chromosome(new AlleleInteger(true, 5));
        ...
        if(gene.equals(Genes.GENE_AI_FOLLOW_GOLEM))
            return new Chromosome(new AlleleBoolean(true, false));
        if(gene.equals(Genes.GENE_AI_FOLLOW_GOLEM_INDEX))
            return new Chromosome(new AlleleInteger(true, 7));

        if(gene.equals(Genes.GENE_AI_FOLLOW_OWNER))
            return new Chromosome(new AlleleBoolean(true, false));
        if(gene.equals(Genes.GENE_AI_FOLLOW_OWNER_INDEX))
            return new Chromosome(new AlleleInteger(true, 5));
        if(gene.equals(Genes.GENE_AI_FOLLOW_OWNER_MOVE_SPEED))
            return new Chromosome(new AlleleDouble(false, 1.0D));
        if(gene.equals(Genes.GENE_AI_FOLLOW_OWNER_MIN_DISTANCE))
            return new Chromosome(new AlleleFloat(false, 5.0F));
        if(gene.equals(Genes.GENE_AI_FOLLOW_OWNER_MAX_DISTANCE))
            return new Chromosome(new AlleleFloat(true, 10.0F));

        if(gene.equals(Genes.GENE_AI_FOLLOW_PARENT))
            return new Chromosome(new AlleleBoolean(true, false));
        if(gene.equals(Genes.GENE_AI_FOLLOW_PARENT_INDEX))
            return new Chromosome(new AlleleInteger(true, 4));
        if(gene.equals(Genes.GENE_AI_FOLLOW_PARENT_MOVE_SPEED))
            return new Chromosome(new AlleleDouble(false, 1.0D));
        ...
        if(gene.equals(Genes.GENE_AI_LEAP_AT_TARGET))
            return new Chromosome(new AlleleBoolean(true, false));
        if(gene.equals(Genes.GENE_AI_LEAP_AT_TARGET_INDEX))
            return new Chromosome(new AlleleInteger(true, 3));
        if(gene.equals(Genes.GENE_AI_LEAP_AT_TARGET_MOTION_Y))
            return new Chromosome(new AlleleFloat(false, 0.4F));

        if(gene.equals(Genes.GENE_AI_LOOK_AT_TRADE_PLAYER))
            return new Chromosome(new AlleleBoolean(true, false));
        if(gene.equals(Genes.GENE_AI_LOOK_AT_TRADE_PLAYER_INDEX))
            return new Chromosome(new AlleleInteger(true, 1));

        if(gene.equals(Genes.GENE_AI_LOOK_AT_VILLAGER))
            return new Chromosome(new AlleleBoolean(true, false));
        if(gene.equals(Genes.GENE_AI_LOOK_AT_VILLAGER_INDEX))
            return new Chromosome(new AlleleInteger(true, 5));
        ...
        if(gene.equals(Genes.GENE_AI_MATE))
            return new Chromosome(new AlleleBoolean(true, false));
        if(gene.equals(Genes.GENE_AI_MATE_INDEX))
            return new Chromosome(new AlleleInteger(true, 2));
        if(gene.equals(Genes.GENE_AI_MATE_MOVE_SPEED))
            return new Chromosome(new AlleleDouble(false, 1.0D));

        if(gene.equals(Genes.GENE_AI_MOVE_INDOORS))
            return new Chromosome(new AlleleBoolean(true, false));
        if(gene.equals(Genes.GENE_AI_MOVE_INDOORS_INDEX))
            return new Chromosome(new AlleleInteger(true, 2));
        ...
        if(gene.equals(Genes.GENE_AI_MOVE_TOWARDS_TARGET))
            return new Chromosome(new AlleleBoolean(true, false));
        if(gene.equals(Genes.GENE_AI_MOVE_TOWARDS_TARGET_INDEX))
            return new Chromosome(new AlleleInteger(true, 2));
        if(gene.equals(Genes.GENE_AI_MOVE_TOWARDS_TARGET_MAX_DISTANCE))
            return new Chromosome(new AlleleFloat(true, 32.0F));
        if(gene.equals(Genes.GENE_AI_MOVE_TOWARDS_TARGET_MOVE_SPEED))
        ...
        if(gene.equals(Genes.GENE_AI_OCELOT_ATTACK))
            return new Chromosome(new AlleleBoolean(true, false));
        if(gene.equals(Genes.GENE_AI_OCELOT_ATTACK_INDEX))
            return new Chromosome(new AlleleInteger(true, 8));

        if(gene.equals(Genes.GENE_AI_OCELOT_SIT))
            return new Chromosome(new AlleleBoolean(true, false));
        if(gene.equals(Genes.GENE_AI_OCELOT_SIT_INDEX))
            return new Chromosome(new AlleleInteger(true, 6));
        if(gene.equals(Genes.GENE_AI_OCELOT_SIT_MOVE_SPEED))
            return new Chromosome(new AlleleDouble(false, 1.0D));

        if(gene.equals(Genes.GENE_AI_OPEN_DOOR))
            return new Chromosome(new AlleleBoolean(true, false));
        if(gene.equals(Genes.GENE_AI_OPEN_DOOR_INDEX))
            return new Chromosome(new AlleleInteger(true, 4));
        if(gene.equals(Genes.GENE_AI_OPEN_DOOR_CLOSE_DOOR))
            return new Chromosome(new AlleleBoolean(false, true));
        if(gene.equals(Genes.GENE_AI_OWNER_HURT_BY_TARGET))
            return new Chromosome(new AlleleBoolean(true, false));
        if(gene.equals(Genes.GENE_AI_OWNER_HURT_BY_TARGET_INDEX))
            return new Chromosome(new AlleleInteger(true, 1));
        if(gene.equals(Genes.GENE_AI_OWNER_HURT_TARGET))
            return new Chromosome(new AlleleBoolean(true, false));
        if(gene.equals(Genes.GENE_AI_OWNER_HURT_TARGET_INDEX))
            return new Chromosome(new AlleleInteger(true, 2));

        if(gene.equals(Genes.GENE_AI_PANIC))
            return new Chromosome(new AlleleBoolean(true, false));
        if(gene.equals(Genes.GENE_AI_PANIC_INDEX))
            return new Chromosome(new AlleleInteger(true, 1));
        if(gene.equals(Genes.GENE_AI_PANIC_MOVE_SPEED))
            return new Chromosome(new AlleleDouble(true, 1.25D));

        if(gene.equals(Genes.GENE_AI_PLAY))
            return new Chromosome(new AlleleBoolean(true, false));
        if(gene.equals(Genes.GENE_AI_PLAY_INDEX))
            return new Chromosome(new AlleleInteger(true, 8));
        if(gene.equals(Genes.GENE_AI_PLAY_MOVE_SPEED))
            return new Chromosome(new AlleleDouble(false, 1.0D));

        if(gene.equals(Genes.GENE_AI_RESTRICT_OPEN_DOOR))
            return new Chromosome(new AlleleBoolean(true, false));
        if(gene.equals(Genes.GENE_AI_RESTRICT_OPEN_DOOR_INDEX))
            return new Chromosome(new AlleleInteger(true, 3));
        ...
        if(gene.equals(Genes.GENE_AI_RUN_AROUND_LIKE_CRAZY))
            return new Chromosome(new AlleleBoolean(true, false));
        if(gene.equals(Genes.GENE_AI_RUN_AROUND_LIKE_CRAZY_INDEX))
            return new Chromosome(new AlleleInteger(true, 1));
        if(gene.equals(Genes.GENE_AI_RUN_AROUND_LIKE_CRAZY_MOVE_SPEED))
            return new Chromosome(new AlleleDouble(false, 1.0D));

        if(gene.equals(Genes.GENE_AI_SIT))
            return new Chromosome(new AlleleBoolean(true, false));
        if(gene.equals(Genes.GENE_AI_SIT_INDEX))
            return new Chromosome(new AlleleInteger(true, 2));
        ...
        if(gene.equals(Genes.GENE_AI_TARGET_NON_TAMED))
            return new Chromosome(new AlleleBoolean(true, false));
        if(gene.equals(Genes.GENE_AI_TARGET_NON_TAMED_INDEX))
            return new Chromosome(new AlleleIntArray(true, new int[]{1}));
        if(gene.equals(Genes.GENE_AI_TARGET_NON_TAMED_TARGET))
            return new Chromosome(new AlleleClassArray(true, new Class[]{EntityChicken.class}));
        if(gene.equals(Genes.GENE_AI_TARGET_NON_TAMED_TARGET_CHANCE))
            return new Chromosome(new AlleleIntArray(true, new int[]{750}));
        if(gene.equals(Genes.GENE_AI_TARGET_NON_TAMED_VISIBLE))
            return new Chromosome(new AlleleBooleanArray(true, new boolean[]{false}));

        if(gene.equals(Genes.GENE_AI_TEMPT))
            return new Chromosome(new AlleleBoolean(true, false));
        if(gene.equals(Genes.GENE_AI_TEMPT_INDEX))
            return new Chromosome(new AlleleIntArray(true, new int[]{2}));
        if(gene.equals(Genes.GENE_AI_TEMPT_ITEM))
            return new Chromosome(new AlleleInventory(true, new ItemStack[]{new ItemStack(Items.wheat)}));
        if(gene.equals(Genes.GENE_AI_TEMPT_MOVE_SPEED))
            return new Chromosome(new AlleleDoubleArray(true, new double[]{1.2D}));
        if(gene.equals(Genes.GENE_AI_TEMPT_SCARED_BY_PLAYER))
            return new Chromosome(new AlleleBooleanArray(true, new boolean[]{false}));

        if(gene.equals(Genes.GENE_AI_TRADE_PLAYER))
            return new Chromosome(new AlleleBoolean(true, false));
        if(gene.equals(Genes.GENE_AI_TRADE_PLAYER_INDEX))
            return new Chromosome(new AlleleInteger(true, 1));

        if(gene.equals(Genes.GENE_AI_VILLAGER_MATE))
            return new Chromosome(new AlleleBoolean(true, false));
        if(gene.equals(Genes.GENE_AI_VILLAGER_MATE_INDEX))
            return new Chromosome(new AlleleInteger(true, 6));
        ...
        if(gene.equals(Genes.GENE_AI_WATCH_CLOSEST_2))
            return new Chromosome(new AlleleBoolean(true, false));
        if(gene.equals(Genes.GENE_AI_WATCH_CLOSEST_2_INDEX))
            return new Chromosome(new AlleleIntArray(true, new int[]{9}));
        if(gene.equals(Genes.GENE_AI_WATCH_CLOSEST_2_CHANCE))
            return new Chromosome(new AlleleFloatArray(true, new float[]{1.0F}));
        if(gene.equals(Genes.GENE_AI_WATCH_CLOSEST_2_RANGE))
            return new Chromosome(new AlleleFloatArray(true, new float[]{3.0F}));
        if(gene.equals(Genes.GENE_AI_WATCH_CLOSEST_2_TARGET))
            return new Chromosome(new AlleleClassArray(true, new Class[]{EntityPlayer.class}));
