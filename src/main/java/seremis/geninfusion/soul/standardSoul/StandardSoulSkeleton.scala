...
class StandardSoulSkeleton extends StandardSoul {
    ...
    override def getChromosomeFromGene(entity: EntityLiving, gene: String): IChromosome = {
        ...
        if(gene.equals(Genes.GENE_DEATH_SOUND))
            return new Chromosome(new Allele[String](true, "mob.skeleton.death"))
        if(gene.equals(Genes.GENE_HURT_SOUND))
            return new Chromosome(new Allele[String](false, "mob.skeleton.hurt"))
        if(gene.equals(Genes.GENE_ITEM_DROPS))
            return new Chromosome(new Allele[Array[ItemStack]](false, Array(new ItemStack(Items.arrow), new ItemStack(Items.bone))))
        if(gene.equals(Genes.GENE_LIVING_SOUND))
            return new Chromosome(new Allele[String](false, "mob.skeleton.say"))
        ...
        if(gene.equals(Genes.GENE_WALK_SOUND))
            return new Chromosome(new Allele[String](true, "mob.skeleton.step"))
        ...
        if(gene.equals(Genes.GENE_AI_ARROW_ATTACK_INDEX))
            return new Chromosome(new Allele[Int](true, 4))
        if(gene.equals(Genes.GENE_AI_ARROW_ATTACK_MAX_RANGED_ATTACK_TIME))
            return new Chromosome(new Allele[Int](false, 60))
        if(gene.equals(Genes.GENE_AI_ARROW_ATTACK_MIN_RANGED_ATTACK_TIME))
            return new Chromosome(new Allele[Int](false, 20))
        ...
        if(gene.equals(Genes.GENE_AI_ARROW_ATTACK_RANGED_ATTACK_TIME_MODIFIER))
            return new Chromosome(new Allele[Float](false, 15F))
        ...
        if(gene.equals(Genes.GENE_AI_RESTRICT_SUN_INDEX))
            return new Chromosome(new Allele[Int](true, 2))

        if(gene.equals(Genes.GENE_AI_FLEE_SUN))
            return new Chromosome(new Allele[Boolean](false, true))
        if(gene.equals(Genes.GENE_AI_FLEE_SUN_INDEX))
            return new Chromosome(new Allele[Int](true, 3))
        ...
        if(gene.equals(Genes.GENE_AI_LOOK_IDLE_INDEX))
            return new Chromosome(new Allele[Int](false, 6))
        ...
        if(gene.equals(Genes.GENE_AI_NEAREST_ATTACKABLE_TARGET_INDEX))
            return new Chromosome(new Allele[Array[Int]](true, Array(2)))
        ...
        if(gene.equals(Genes.GENE_AI_NEAREST_ATTACKABLE_TARGET_NEARBY_ONLY))
            return new Chromosome(new Allele[Array[Boolean]](true, Array(false)))
        if(gene.equals(Genes.GENE_AI_NEAREST_ATTACKABLE_TARGET_TARGET))
            return new Chromosome(new Allele[Array[Class[_]]](false, Array(classOf[EntityPlayer])))
        if(gene.equals(Genes.GENE_AI_NEAREST_ATTACKABLE_TARGET_TARGET_CHANCE))
            return new Chromosome(new Allele[Array[Int]](true, Array(0)))
        if(gene.equals(Genes.GENE_AI_NEAREST_ATTACKABLE_TARGET_VISIBLE))
            return new Chromosome(new Allele[Array[Boolean]](true, Array(true)))



        if(gene.equals(Genes.GENE_MODEL))
            return new Chromosome(new Allele[Array[ModelPart]](true, ModelPart.getModelPartsFromModel(new ModelSkeleton(), entity)))
        if(gene.equals(Genes.GENE_TEXTURE))
            return new Chromosome(new Allele[String](true, "textures/entity/skeleton/skeleton.png"), new Allele[String](false, "textures/entity/skeleton/skeleton.png"))
