...
public class BlockCompressorRenderer implements ISimpleBlockRenderingHandler {
    ...
    public boolean renderBlockCompressor(Block block, int x, int y, int z, RenderBlocks renderer, boolean item) {
        ...
        for(int var7 = 0; var7 < 10; var7++) {
            ...
            if(item) {
                block.setBlockBounds(var8, var9, var10, var11, var12, var13);
                renderer.setRenderBoundsFromBlock(block);
                GIRenderHelper.renderAllFaces(block, renderer, block.getIcon(0, 0), block.getIcon(1, 0), block.getIcon(2, 0), block.getIcon(3, 0), block.getIcon(4, 0), block.getIcon(5, 0));
            }
        }
