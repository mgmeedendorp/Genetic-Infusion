...
public class ModItems {
    ...
    public static GIItem crystalShard;
    public static GIItem plateTitanium;
    public static GIItem crystalAlloy;
    ...
    public static void init() {
        ...
        plateTitanium = new GIItem().setUnlocalizedName(Items.TITANIUM_PLATE_UNLOCALIZED_NAME);
